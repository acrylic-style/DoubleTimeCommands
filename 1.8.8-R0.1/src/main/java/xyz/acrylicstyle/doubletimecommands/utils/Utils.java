...
public final class Utils {
    ...
    public static void morningCall(final UUID player) {
        ...
        final Objective objective = board.registerNewObjective("subToLetMeHitIt", "dummy");
    ...
    public static void getPoints(org.bukkit.entity.Player player, Callback<Long> callback) {
    ...
    public static void getExperience(org.bukkit.entity.Player player, Callback<Long> callback) {
    ...
    public static void addPoints(org.bukkit.entity.Player player, long points) {
    ...
    public static void addExperience(org.bukkit.entity.Player player, long experience) {
